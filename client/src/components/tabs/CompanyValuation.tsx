          ...
          <table className="min-w-full divide-y divide-neutral-200">
            <thead>
              <tr>
                ...
                <th className="px-4 py-3 bg-neutral-100 text-right text-xs font-medium text-neutral-600 uppercase tracking-wider">2022</th>
                <th className="px-4 py-3 bg-neutral-100 text-right text-xs font-medium text-neutral-600 uppercase tracking-wider">2023</th>
                <th className="px-4 py-3 bg-neutral-100 text-right text-xs font-medium text-neutral-600 uppercase tracking-wider">2024</th>
            ...
            <tbody className="bg-white divide-y divide-neutral-200">
              <tr>
                ...
                <td className="px-4 py-2 text-sm text-right">${sampleProjectedData.revenue['2022'].toLocaleString()}</td>
                <td className="px-4 py-2 text-sm text-right">${sampleProjectedData.revenue['2023'].toLocaleString()}</td>
                <td className="px-4 py-2 text-sm text-right">${sampleProjectedData.revenue['2024'].toLocaleString()}</td>
              ...
              <tr>
                ...
                <td className="px-4 py-2 text-sm text-right">${sampleProjectedData.ebitda['2022'].toLocaleString()}</td>
                <td className="px-4 py-2 text-sm text-right">${sampleProjectedData.ebitda['2023'].toLocaleString()}</td>
                <td className="px-4 py-2 text-sm text-right">${sampleProjectedData.ebitda['2024'].toLocaleString()}</td>
              ...
              <tr>
                ...
                <td className="px-4 py-2 text-sm text-right">${sampleProjectedData.netIncome['2022'].toLocaleString()}</td>
                <td className="px-4 py-2 text-sm text-right">${sampleProjectedData.netIncome['2023'].toLocaleString()}</td>
                <td className="px-4 py-2 text-sm text-right">${sampleProjectedData.netIncome['2024'].toLocaleString()}</td>
              ...
              <tr>
                ...
                <td className="px-4 py-2 text-sm text-right">${sampleProjectedData.freeCashFlow['2022'].toLocaleString()}</td>
                <td className="px-4 py-2 text-sm text-right">${sampleProjectedData.freeCashFlow['2023'].toLocaleString()}</td>
                <td className="px-4 py-2 text-sm text-right">${sampleProjectedData.freeCashFlow['2024'].toLocaleString()}</td>
